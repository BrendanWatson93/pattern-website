...
const Crochet = () => {
  ...
  useEffect(() => {
    const getProduct = async () => {
      const response = await fetch("/api/products/crochet");
  ...
  return (
    <div className="bg-gradient-to-r from-purple-900 to-blue-900">
      <div className="flex justify-center">
        <h1 className="Heading1 py-8 ">Crochet</h1>
      </div>
      <p className="text-center pb-8 text">
        BROWSE OUR COLLECTION OF CROCHET PATTERNS
      </p>
      ...
      <div className="flex pt-8 justify-center">
        <div className="max-w-[80%] grow  rounded-lg p-8  bg-white rounded-r-sm bg-opacity-30 backdrop-filter backdrop-blur-lg">
          ...
          <div className="grid grid-cols-5 gap-5 py-2 px-3">
            {products &&
